...
export default function Page(){
    ...
    <div className="relative block md:flex items-center">
      <div className="w-full md:w-1/2 relative z-1 bg-gray-100 rounded shadow-lg overflow-hidden">
        <div className="text-lg font-medium text-green-500 uppercase p-8 text-center border-b border-gray-200 tracking-wide">Información</div>
        <div className="block sm:flex md:block lg:flex items-center justify-center">
          <div className="mt-8 sm:m-8 md:m-0 md:mt-8 lg:m-8 text-center">
            ...
            <span className="block text-sm text-gray-600 mt-2"><img src="me.png"></img></span>
          </div>
        ...
        <div className="flex justify-center mt-3">
          <ul>
            ...
            <li className="flex items-center mt-3">
              ...
              <span className="text-gray-700 text-lg ml-3">Cédula profesional: 12490409 UAÉMEX</span>
            </li>
          </ul>
        </div>
      ...
      <div className="w-full md:w-1/2 relative z-0 px-8 md:px-0 md:py-16">
        <div className="bg-blue-900 text-white rounded-b md:rounded-b-none md:rounded-r shadow-lg overflow-hidden">
          <div className="text-lg font-medium uppercase p-8 text-center border-b border-blue-800 tracking-wide">Nutriña</div>
    ...
    <div className="bg-white w-60 h-64 shadow-md rounded m-8">
      ...
      <div className="w-full h-1/4 p-3">
        <a href="#" className=" hover:text-yellow-600 text-gray-700">
          <span className="text-lg font-semibold uppercase tracking-wide ">Misión</span>
        </a>
        <p className="text-gray-600 text-sm leading-5 mt-1">
        Brindar servicios de nutrición de calidad con calidez y profesionalismo, basado en evidencia científica, acordes a las necesidades de cada paciente, y al mismo tiempo aportar las herramientas necesarias en materia de educación nutricional para el empoderamiento personal.</p>
      </div>
    </div>
    <div className="bg-white w-52 h-64 shadow-md rounded m-3">
      ...
      <div className="w-full h-1/4 p-3">
        <a href="#" className=" hover:text-yellow-600 text-gray-700">
          <span className="text-lg font-semibold uppercase tracking-wide ">Visión</span>
        </a>
        <p className="text-gray-600 text-sm leading-5 mt-1">Ser un Consultorio Nutricional que brinde servicios especializados que satisfagan las necesidades de la población para contribuir en la mejora de la Salud Pública.</p>
      </div>
    </div>
  </main>
        </div>
